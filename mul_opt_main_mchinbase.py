...
def run_simulation(cfg):
    ...
    # Ge = scale_value(results[0])  # MCH生成量
    # Le = scale_value(results[1])  # 電力消費量
    Se = results[2] / (10**12)  # 拠点へのMCH供給量
    Ms = results[3]  # 貯蔵量マイナスのペナルティ

    objective_value = Se - Ms
...
def main(cfg: DictConfig) -> None:
    ...
    storage = "sqlite:///experiences/catmaran_discuss_mul_opt_mchinbase.db"
    ...
    for i in range(row_num):
        ...
        Se = sum_supply_elect / (10**12)
        Ms = minus_storage_penalty
