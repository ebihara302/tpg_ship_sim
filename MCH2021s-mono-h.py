...
def objective(trial):
    ...
    max_storage_GWh = trial.suggest_int(
        "tpgship_max_storage_GWh", 50, 600
    ...
    sail_area_100m2 = trial.suggest_int("tpgship_sail_area_every_100m2", 10, 100)
    ...
    # 輸送船呼び出しタイミングに関する変更
    config.storage_base.call_per = 1
...
def main(cfg: DictConfig) -> None:
    ...
    storage = f"sqlite:///experiences/MCH_{sim_year}s_mono-h.db"
