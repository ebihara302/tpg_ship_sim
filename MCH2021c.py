...
def objective(trial):
    ...
    max_storage_GWh = trial.suggest_int(
        "tpgship_max_storage_GWh", 400, 450
    ...
    sail_area_100m2 = trial.suggest_int("tpgship_sail_area_every_100m2", 80, 90)
    ...
    config.tpg_ship.generator_turbine_radius = trial.suggest_int(
        "tpgship_generator_turbine_radius", 11, 15
    )
...
def main(cfg: DictConfig) -> None:
    ...
    storage = f"sqlite:///experiences/MCH_{sim_year}c.db"
